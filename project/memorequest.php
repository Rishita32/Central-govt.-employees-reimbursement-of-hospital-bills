<?php
    ...
    {   
        ...
        $sql="INSERT INTO memo_table(firstname,lastname,cardtype,id,Relation,age,gender,symptoms,email) values('$fname' , '$lname' , '$card','$beneficiary','$relation','$age', '$gender','$symptoms', '$email')";
        ...
        echo "<script>
setTimeout(function () {
   window.location.href= 'http://localhost/Governmentweb/index.php';
}, 500);
</script>";
        #sleep(5);
